...
import { Map, MapControls, MapMarker, MapPopup } from './ui/map'
      ...
      >
        ...
        {position && (
          <MapMarker longitude={position[0]} latitude={position[1]}>
            ...
            >
              <div className="p-2">
                <h3 className="font-bold text-lg mb-2 text-blue-600 dark:text-blue-400">📍 Tu ubicación actual</h3>
                <p className="text-sm text-gray-700 dark:text-gray-300">
                  Latitud: <span className="font-mono">{position[1].toFixed(6)}</span><br />
                  Longitud: <span className="font-mono">{position[0].toFixed(6)}</span>
                </p>
              </div>
            </MapPopup>
          </MapMarker>
